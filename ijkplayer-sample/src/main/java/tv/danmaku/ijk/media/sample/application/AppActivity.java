...
import tv.danmaku.ijk.media.sample.activities.LiveOnlineActivity;
...
public class AppActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        }else if (id==R.id.action_native){
            FileExplorerActivity.intentTo(this);
        }else if (id==R.id.action_liveonline){
            LiveOnlineActivity.intentTo(this);
        }
